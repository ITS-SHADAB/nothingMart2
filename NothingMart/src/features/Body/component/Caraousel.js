            ...
            >
              <ol className="carousel-indicators">
                <li
                  ...
                  className="active"
                />
                <li data-bs-target="#header-carousel" data-bs-slide-to={1} />
                <li data-bs-target="#header-carousel" data-bs-slide-to={2} />
              </ol>
